...
import {PLANS_CONTENT} from "../constants/index.jsx";
                    ...
                    className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                    {
                        PLANS_CONTENT.plans.map((plan,index)=>(
                            ...
                            ${
                            ...
                            }`}>
                                {
                                    plan.popular && (
                                        <div className='text-center mb-4'>
                                            ...
                                            py-1 px-3 rounded-full uppercase'>
                                                {PLANS_CONTENT.popularBadge}                                            </span>
                                        </div>
                                    )
                                }
                                ...
                                <button className='w-full py-3 px-4 bg-blue-600 hover:bg-blue-500
                                rounded-lg'>
